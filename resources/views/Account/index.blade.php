...
#privcp:-webkit-scrollbar {
  ...
  ?>
     ...
     <div class="container mt-8" style="width:100%;padding-top:40px;display:inline-block;text-align:center;">

    <div class="row" style="display:flex;justify-content:center;margin:30px;margin-top:20px;height:85%;">
          ...
          <div style="width:100%;display:block;"><h1>Edit Content</h1></div>
            ...
            <div class="course" style="display:none;margin-top:85px;">
             ...
             <div id="alert" style="background:green;color:white;font-size:20px;"></div>
                <div id="courss" style="height:80%;overflow-y:scroll;">
